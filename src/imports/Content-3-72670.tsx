import svgPaths from "./svg-levcrdszmr";
  ...
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Text">
      <p className="basis-0 font-['Roboto:Regular',sans-serif] font-normal grow leading-[44px] min-h-px min-w-px relative shrink-0 text-[#5e6c84] text-[36px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        No hay solicitudes en trámite - NO aparecen las tabs.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="overflow-clip relative shrink-0 size-[24px]" data-name="myIcon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_3_72674)" id="react-icons/MdSettings">
          <g id="Vector"></g>
          <g id="Vector_2">
            <mask fill="white" id="path-1-inside-1_3_72674">
              <path d={svgPaths.p21306680} />
            </mask>
            <path d={svgPaths.p21306680} fill="var(--fill-0, #091E42)" mask="url(#path-1-inside-1_3_72674)" stroke="var(--stroke-0, #091E42)" strokeWidth="2" />
          </g>
        </g>
        <defs>
          <clipPath id="clip0_3_72674">
...
function ReactIconsMdOutlineCategory() {
  return (
    <div className="absolute bottom-[16.67%] left-0 right-[16.67%] top-0" data-name="react-icons/MdOutlineCategory">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_3_72686)" id="react-icons/MdOutlineCategory">
          <g id="Vector"></g>
          <path d={svgPaths.p3410f080} fill="var(--fill-0, #0052CC)" id="Vector_2" />
        </g>
        <defs>
          <clipPath id="clip0_3_72686">
...
function ActionDelete() {
  return (
    <div className="basis-0 grow h-full min-h-px min-w-px relative shrink-0" data-name="Action/delete">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_3_72678)" id="Action/delete">
          <g id="Vector"></g>
          <path d={svgPaths.pdaa9e00} fill="var(--fill-0, #DE350B)" id="Vector_2" />
        </g>
        <defs>
          <clipPath id="clip0_3_72678">
            <rect fill="white" height="16" width="16" />
          </clipPath>
        </defs>
      </svg>
